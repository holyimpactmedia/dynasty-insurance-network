        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-2">
              We collect personal information that you voluntarily provide when using our Site, including:
            </p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              ...
              <li>Health insurance preferences and priorities</li>
            </ul>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              in health insurance plans. These agents are independent contractors or employees who are licensed to sell
              insurance in your state.
            </p>

            <h3 className="text-xl font-semibold mb-2 mt-4">4.2 Insurance Carriers</h3>
            <p className="text-muted-foreground leading-relaxed">
              With your consent, we may share your information with insurance carriers to obtain quotes and process
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              as hosting, analytics, customer service, and marketing. These providers are contractually obligated to
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We use cookies and similar tracking technologies to enhance your experience on our Site. Cookies are small
              files stored on your device that help us remember your preferences, understand how you use our Site, and
              improve our services. You can control cookies through your browser settings, but disabling cookies may
              limit your ability to use certain features of the Site.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-3">6. Third-Party Analytics</h2>
            <h3 className="text-xl font-semibold mb-2 mt-4">6.1 Google Analytics</h3>
            <p className="text-muted-foreground leading-relaxed">
              ...
              prior to coming to our Site. We use this information to improve our Site and services. You can opt out of
              Google Analytics by visiting https://tools.google.com/dlpage/gaoptout.
            </p>

            <h3 className="text-xl font-semibold mb-2 mt-4">6.2 Advertising and Remarketing</h3>
            <p className="text-muted-foreground leading-relaxed">
              We may use third-party advertising services to show ads on other websites to users who have previously
              visited our Site. These services may use cookies to serve ads based on your past visits to our Site.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              storage is 100% secure. While we strive to protect your information, we cannot guarantee its absolute
              security.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">9. Your Rights and Choices</h2>
            <p className="text-muted-foreground leading-relaxed mb-2">You have certain rights regarding your personal information:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              <li>
              ...
              <li>
                <strong>Do Not Call:</strong> You can request to be added to our internal do-not-call list
              </li>
            </ul>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our Site is not directed to children under the age of 18, and we do not knowingly collect personal
              information from children. If we become aware that we have collected personal information from a child
              without parental consent, we will take steps to delete that information. If you believe we have collected
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              laws. We will post the updated policy on this page and update the "Last Updated" date. We encourage you to
              review this Privacy Policy periodically. Your continued use of the Site after changes are posted
              constitutes your acceptance of the updated policy.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-3">14. Third-Party Websites</h2>
            <p className="text-muted-foreground leading-relaxed">
              Our Site may contain links to third-party websites. We are not responsible for the privacy practices of
              these websites. We encourage you to read the privacy policies of any third-party sites you visit.
            </p>
          </section>
