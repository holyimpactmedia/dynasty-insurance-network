        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              hosting and database infrastructure (Vercel, Neon), email delivery (Resend), TCPA proof-of-consent (TrustedForm by ActiveProspect), advertising and conversion measurement (Meta Platforms),
