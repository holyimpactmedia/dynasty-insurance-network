...
export default function BusinessPage() {
  ...
  useEffect(() => {
    ...
    const SESSION_KEY = "exitIntentShown_business"
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <ExitIntentDialog
        ...
        progress={progress}
        savingsAmount="$5,520"
        savingsTimeframe="/employee/year"
        headline="Walk away and your team keeps overpaying solo."
            ...
            {showRedirect ? (
              ...
              <div className="w-full max-w-none">
                ...
                <section className="relative text-white py-16 px-6 overflow-hidden">
                  <img src="/images/heroes/business.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" aria-hidden="true" />
