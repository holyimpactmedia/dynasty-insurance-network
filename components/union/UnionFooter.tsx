  ...
  return (
    <footer style={{ background: "var(--color-navy-deep)", color: "#8ba0bb", padding: "clamp(48px,6vw,72px) clamp(18px,5vw,48px) 40px" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "space-between", marginTop: 24, paddingTop: 20, borderTop: "1px solid rgba(255,255,255,.1)", fontSize: 12.5, color: "#7f95b2" }}>
